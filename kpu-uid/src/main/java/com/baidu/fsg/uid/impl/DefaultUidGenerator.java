 ...
 * <li>delta seconds: The next 28 bits, represents delta seconds since a customer epoch(2024/02/07  02:04.000).
 * Supports about 8.7 years until to 2024/02/07  02:04
 ...
 * <li>epochStr: Epoch date string format 'yyyy-MM-dd'. Default as '2024-02-07'<p>
 *
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    /**
     * Customer epoch, unit as second. For example 2024/02/07 (ms: 1463673600000)
     * 可以改成你的项目开始开始的时间
     */
    private String epochStr = "2024-02-07";
    /**
