package cn.lmx.basic.database.datasource.defaults;


import cn.lmx.basic.database.datasource.BaseDatabaseConfiguration;
 ...
 * kpu.database.multiTenantType != DATASOURCE时， 子类需要继承它，并让程序启动时加载
 * <p>
 ...
 * <p>
 * 1. 本类的子类的 @MapperScan(basePackages = {"cn.lmx.basic"}) 修改为  @MapperScan(basePackages = {"cn.lmx.basic.product.dao"})
 ...
 * 3. 在kpu-xxx-server层复制该类，重命名为 SlaveDatabaseAutoConfiguration （跟AuthorityDatabaseAutoConfiguration放一起）
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"cn.lmx.basic"}, 修改为  basePackages = {"cn.lmx.basic.order.dao"} # 这个路径根据你的情况修改
