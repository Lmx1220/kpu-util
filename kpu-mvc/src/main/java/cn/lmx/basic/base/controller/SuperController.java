 ...
 * @date 2023/7/4 14:27
 */
public abstract class SuperController<S extends SuperService<Id, Entity, SaveVO, UpdateVO, PageQuery, ResultVO>, Id extends Serializable, Entity extends SuperEntity<Id>, SaveVO, UpdateVO, PageQuery, ResultVO> extends SuperSimpleController<S, Id, Entity, SaveVO, UpdateVO, PageQuery, ResultVO>
        implements SaveController<Id, Entity, SaveVO, UpdateVO, PageQuery, ResultVO>, UpdateController<Id, Entity, SaveVO, UpdateVO, PageQuery, ResultVO>, DeleteController<Id, Entity, SaveVO, UpdateVO, PageQuery, ResultVO>, PoiController<Id, Entity, SaveVO, UpdateVO, PageQuery, ResultVO>, QueryController<Id, Entity, SaveVO, UpdateVO, PageQuery, ResultVO> {
